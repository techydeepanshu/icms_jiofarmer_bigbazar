...
const Queue=()=>{
  ...
  return(
    <div style={{marginTop:"90px"}}>
            ...
            <div style={{border:"1px solid grey",margin:"10px"}}>
              ...
              <div className="row" style={{marginBottom:"10px"}}>
                ...
                <div className="col-md-3">
                  <button className="btn btn-sm btn-primary" onClick={()=>{setShowModal(true);setContentExtra(q);}}>Details</button>
                </div>
              </div>
            </div>
          </div>
      ...
      {showModal?
        <table className="table table-bordered table-sm" style={{marginTop:"40px"}}>
          <thead className="thead-dark">
            <tr>
              {header.map((o,i)=>(
                <th key={i} scope="col">{o}</th>
              ))}
            </tr>
          </thead>
        <tbody>
